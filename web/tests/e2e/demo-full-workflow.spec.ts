...
test.describe('Full End-to-End Demo Workflow', () => {
  test('Complete audiobook workflow: from empty library to organized books', async ({ page }) => {
    ...
    await page.screenshot({ path: 'full_demo_01_dashboard.png', fullPage: true });
    ...
    if (await emptyState.isVisible().catch(() => false)) {
      await page.screenshot({ path: 'full_demo_02_library_empty.png', fullPage: true });
    ...
    await page.screenshot({ path: 'full_demo_03_library_with_books.png', fullPage: true });
    ...
    await page.screenshot({ path: 'full_demo_04_library_scrolled.png', fullPage: true });
    ...
    if (await bookLink.isVisible().catch(() => false)) {
      ...
      await page.screenshot({ path: 'full_demo_05_book_detail.png', fullPage: true });
      ...
      await page.screenshot({ path: 'full_demo_06_book_detail_metadata.png', fullPage: true });
    ...
    await page.screenshot({ path: 'full_demo_07_library_final.png', fullPage: true });
    ...
    await page.screenshot({ path: 'full_demo_08_settings.png', fullPage: true });
    ...
    await page.evaluate(() => window.scrollBy(0, 300));
    await page.waitForTimeout(800);
    await page.screenshot({ path: 'full_demo_09_settings_scrolled.png', fullPage: true });
    ...
    try {
      ...
      if (fileBrowserVisible) {
        await page.screenshot({ path: 'full_demo_10_file_browser.png', fullPage: true });
    ...
    await page.screenshot({ path: 'full_demo_11_operations.png', fullPage: true });
    ...
    await page.screenshot({ path: 'full_demo_12_final_dashboard.png', fullPage: true });
