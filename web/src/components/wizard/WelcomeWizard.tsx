        ...
        <DialogContent>
          ...
          {activeStep === 0 && (
            <Box>
              ...
              <Typography variant="body2" color="text.secondary" paragraph>
                This is where your organized audiobooks will be stored. The app will create a structured
                folder hierarchy here based on your naming patterns.
              </Typography>
              ...
              <Alert severity="info">
                Choose a location with plenty of storage space. This will be the permanent home
                for your organized audiobook collection.
              </Alert>
            </Box>
          )}
          ...
          {activeStep === 1 && (
            <Box>
              ...
              <Typography variant="body2" color="text.secondary" paragraph>
                Enable AI-powered author name parsing and metadata enhancement with OpenAI.
                This is optional and can be configured later in Settings.
              </Typography>
          ...
          {activeStep === 2 && (
            <Box>
              ...
              <Alert severity="info">
                You can add import folders later in the Library page if you prefer to skip this step.
              </Alert>
            </Box>
          )}
        </DialogContent>
