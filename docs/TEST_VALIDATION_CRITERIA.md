...
This document defines pass/fail criteria for manual testing scenarios and
provides templates for reporting issues discovered during QA.
...
- **Validation**: Rejects invalid hash formats:
  ...
  - Empty reason: Valid hash, blank reason → Error: "Hash and reason are
    required"
...
**Note**: Blocked hash (if created during delete) remains blocked after restore
(expected behavior).
...
**Scenario ID**: [e.g., 1.2 Apply Override from File Value] **Priority**: [P0 /
P1 / P2] **Severity**: [Critical / High / Medium / Low]
...
**Screenshots**: [Attach images] **Logs**:
```
...
**Category**: [UX / Performance / Accessibility / Documentation] **Priority**:
[P1 / P2 / P3]
...
- **1.0.0** (2025-12-28): Initial validation criteria and issue templates
  created
