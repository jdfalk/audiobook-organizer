...
2. Section 5.2 — Fix Dockerfile Node version
3. Section 5.3 — Align coverage thresholds
4. Section 4.2 — Graceful HTTPS degradation
5. Section 4.1 — Config validation
6. Section 6.1 — Fix flaky test

### Phase 3: Frontend Polish

13. Section 3.1 — Fix Login page
2. Section 3.3 — Dark mode toggle
3. Section 3.5 — Search integration
4. Section 3.4 — QuotaTab real data
5. Section 3.7 — Error boundaries
6. Section 3.8 — Loading states
7. Section 9.6 — Empty states
8. Section 9.5 — Toast notifications

### Phase 4: Backend Hardening

21. Section 4.3 — Organizer partial file cleanup
2. Section 4.4 — Scanner symlink loop protection
3. Section 4.5 — Stuck operation detection
4. Section 8.1 — SQLite WAL mode

### Phase 5: Deployment & Distribution

25. Section 5.4 — docker-compose.yml
2. Section 5.5 — .env.example
3. Section 5.6 — macOS launchd plist
4. Section 5.7 — Verify Docker build end-to-end
5. Section 10.3 — Binary smoke test in CI
6. Section 10.5 — Installation script

### Phase 6: Testing & Documentation

31. Section 6.2 — Manual QA checklist
2. Section 6.3 — Full workflow integration test
3. Section 6.4 — Coverage to 85%+
4. Section 6.5 — Frontend test coverage
5. Section 6.6 — E2E auth flow test
6. Section 7.1 — README overhaul
7. Section 7.3 — Environment variables docs
8. Section 7.4 — Architecture docs

### Phase 7: Performance & Nice-to-Have

39. Section 8.2 — Query optimization
2. Section 8.4 — Full-text search (FTS5)
3. Section 3.2 — Works page (decide: implement or remove)
4. Section 9.1 — Favicon and app icons
5. Section 9.2 — PWA manifest
6. Section 9.3 — Responsive design audit
7. Section 9.4 — Keyboard shortcuts
8. Section 7.2 — OpenAPI spec completion

### Phase 8: Final Polish

47. Section 3.6 — Remove unused API functions
2. Section 8.3 — In-memory cache
3. Section 8.5 — Concurrent request handling
4. Section 9.7 — Confirmation dialogs
5. Section 10.1 — GoReleaser token permissions
6. Section 10.2 — Changelog generation
7. Section 10.4 — Docker image publishing
8. Systemd watchdog integration — detect `WATCHDOG_USEC` env, send `sd_notify("WATCHDOG=1")` keepalive pings, update service file to `Type=notify` with `WatchdogSec=30s` (Linux only, no-op on other platforms)
