<!-- file: docs/archive/refactoring-libraryfolder-importpath/REFACTORING_CHECKLIST.md -->
<!-- version: 1.0.0 -->
<!-- guid: b2c3d4e5-f6a7-8b9c-0d1e-2f3a4b5c6d7e -->

# LibraryFolder -> ImportPath Refactoring Checklist (Archived)

This document has been archived from the repository root. The original checklist content is preserved below for reference.
...
- [ ] Line 1244: Call `database.GlobalStore.UpdateLibraryFolder` ->
      `database.GlobalStore.UpdateImportPath`
- [ ] Line 1379 comment: "Trigger automatic rescan of library folder" ->
      "Trigger automatic rescan of import paths"
...
- 	9 All Go unit tests passing
- 	9 Frontend builds successfully
- 	9 API endpoints functional at new URLs
- 	9 UI correctly displays "Import Paths" terminology
- 	9 Manual testing of add/remove import paths

## Breaking Changes

6a0
en**API endpoints changed**:
...
Good luck with the refactoring! 680
