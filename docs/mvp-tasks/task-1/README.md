...
2. Read TASK-1-CORE-TESTING.md completely (30 min)
3. Execute Phase 1-5 exactly as written (20 min)
4. Verify all passes

**Then proceed to advanced testing:**
5. Read TASK-1-ADVANCED-SCENARIOS.md (25 min)
6. Run scenarios A, B, C as time permits (30-60 min)

**If issues occur:**
7. Reference TASK-1-TROUBLESHOOTING.md (10-15 min to find issue)
...
- Core testing: Execute TASK-1-CORE-TESTING.md phases 1-5
- Large libraries: TASK-1-ADVANCED-SCENARIOS.md Scenario A
- Concurrent ops: TASK-1-ADVANCED-SCENARIOS.md Scenario B
- Issues: TASK-1-TROUBLESHOOTING.md (use index)
...
**If any check fails**, reference TASK-1-TROUBLESHOOTING.md Issue #1-6.
...
│ If issues occur, reference TASK-1-TROUBLESHOOTING.md        │
└─────────────────────────────────────────────────────────────┘
```
...
```
Read TASK-1-ADVANCED-SCENARIOS.md
        │
...
**IMPORTANT:** This task is designed for multi-agent execution. Follow the idempotency rules in **TASK-1-CORE-TESTING.md** section "⚠️ CRITICAL: Idempotency & Multi-Agent Safety"
...
See TASK-1-CORE-TESTING.md for complete protocol.
...
1. Read TASK-1-CORE-TESTING.md completely
...
- **Questions about advanced setups?** → TASK-1-ADVANCED-SCENARIOS.md
- **Issues during testing?** → TASK-1-TROUBLESHOOTING.md
- **Need command reference?** → This file (Quick Commands section)

### From Advanced Scenarios (Part 2)

- **Need basics review?** → TASK-1-CORE-TESTING.md
- **Troubleshooting an issue?** → TASK-1-TROUBLESHOOTING.md
- **Want to understand code?** → Same document (Code Deep Dive section)

### From Troubleshooting (Part 3)

- **Need to understand workflow?** → TASK-1-CORE-TESTING.md
- **Want advanced scenarios?** → TASK-1-ADVANCED-SCENARIOS.md
...
- **Need to start?** → Go to TASK-1-CORE-TESTING.md
- **Confused by output?** → Check TASK-1-CORE-TESTING.md Phase 3 "Expected Outputs"
- **Something broken?** → Search TASK-1-TROUBLESHOOTING.md Index
- **Want advanced testing?** → Read TASK-1-ADVANCED-SCENARIOS.md
...
1. **For immediate testing:** Go to TASK-1-CORE-TESTING.md and start Phase 1
2. **For complete understanding:** Read this README, then Core, then Advanced
3. **For troubleshooting:** Jump to TASK-1-TROUBLESHOOTING.md and find your issue
